...
\end{equation}
\item 
Given that  x(n) = \cbrak{\underset{\uparrow}{1},2,3,4,2,1} \\ So,N=6 then above equation becomes
\begin{equation}
...
\end{align}
\begin{align}
\hspace{12mm}    H(z) = \frac{1+z^{-2}}{1+\frac{1}{2}z^{-1}}
\end{align}
\hspace{17mm}
From this we can say that h(n) is,
\begin{align}
\hspace{19mm}    h(n)= Z^{-1}\sbrak{\frac{1}{1+\frac{1}{2}z^{-1}} + \frac{z^{-2}}{1+\frac{1}{2}z^{-1}}}
\end{align}
\begin{align}
\hspace{19mm}    h(n)=\sbrak{\frac{-1}{2}}^nu(n) + \sbrak{\frac{-1}{2}}^{n-2}u(n-2)
\end{align}
\vspace{3mm}
\hspace{17mm}
Now for the calculations we can \
\hspace{17mm} assume that length of h(n) is same as length of x(n) i.e., N = 6.
