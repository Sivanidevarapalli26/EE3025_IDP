...
plt.savefig('figs/ee18btech11012_IIR_Lowpass.eps')
...
plt.savefig('figs/ee18btech11012_IIR_Bandpass.eps')
...
plt.savefig('figs/ee18btech11012_digital_IIR_Bandpass.eps')
